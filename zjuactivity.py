...
class ZJUActivity(ZJUAUTHME):
    ...
    def _get_xiaoqu(self, csrf_token=None):
        ...
        其中stepId只需指定一个"报告会、论坛、讲座活动审批"的流程ID即可，无需是自己创建的
        """
        if csrf_token is None:
            return self.CACHE["xiaoqu"]
        xiaoqu_r = self.a.post_dict(self.DOMAIN+"/infoplus/interface/suggest",{"stepId":"408560","prefix":"","type":"Code","code":"xiaoQu","parent":"","isTopLevel":"true","pageNo":"0","rand":"","settings":"{}","csrfToken":csrf_token,"lang":"en"})
    ...
    def _get_louyu(self, xiaoqu, csrf_token=None):
        ...
        louyu_r = self.a.post_dict(self.DOMAIN+"/infoplus/interface/suggest",{"stepId":"408560","prefix":"","type":"Code","code":"LouYu","parent":xiaoqu,"isTopLevel":"false","pageNo":"0","rand":"","settings":"{}","csrfToken":csrf_token,"lang":"en"})
    ...
    def _get_zy(self, louyu, csrf_token=None):
        ...
        zy_r = self.a.post_dict(self.DOMAIN+"/infoplus/interface/suggest",{"stepId":"408560","prefix":"","type":"Code","code":"ZY","parent":louyu,"isTopLevel":"false","pageNo":"0","rand":"","settings":"{}","csrfToken":csrf_token,"lang":"en"})
    ...
    def _query(self, ziyuan_id, csrf_token):
        ...
        """
        query_r = self.a.post(self.DOMAIN+"/infoplus/interface/fieldChanging","stepId=408560&formData=%7B%22fieldSQCDZY%22%3A%22{ziyuan_id}%22%7D&fieldName=fieldSQCDbtnQuery&fieldValue=&path=&csrfToken={csrf_token}".format(**locals()))
